...
import { SDKConfigWithObjects, StreamInfo } from '@/types';
...
export class VaultOperations {
  ...
  constructor(config: SDKConfigWithObjects) {
    this.client = config.client;
    this.accountActionsPackageId = config.packages.accountActions;
    this.packageRegistryId = config.sharedObjects.packageRegistry.id;
    this.configType = `${config.packages.futarchyCore}::futarchy_config::FutarchyConfig`;
  }
