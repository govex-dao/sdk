/**
 * Governance Action Types - Action configurations for governance operations
 *
 * Includes: Package Registry, Protocol Admin
 *
 * @module types/protocol/actions/governance
 */
...
/**
 * Union of all governance action configurations
 */
export type GovernanceActionConfig =
  // Package Registry
